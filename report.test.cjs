...
test('CSV export and copy success/failure',async()=>{
 const x=setup();x.input('#search','PIT-F001');x.$('#export-button').click();assert.equal(x.w.downloaded,'pitcher-uat-interim-findings-20260911.csv');assert.ok(x.w.exported.size>100);
